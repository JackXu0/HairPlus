...
public class AddLike extends Thread {
    ...
    public AddLike(Handler handler, String username, int postId){
    ...
    public void run() {
        ...
        Request request1 = requestBuilder.url("http://120.79.237.66:8000/addLike")
